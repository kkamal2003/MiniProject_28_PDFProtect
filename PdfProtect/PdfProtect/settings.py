"""
Django settings for PdfProtect project.
...
SECRET_KEY = 'django-insecure-1$g0%u19$vr@v$4#m4(l_x37hqcx*@s2459o6n)n&y9$3)06ek'
...
WSGI_APPLICATION = 'PdfProtect.wsgi.application'
